...
def call_openai_responses(api_key: str, model: str, prompt: str, fixed_params: dict):
    ...
    r = _post_with_retries(OPENAI_RESPONSES_URL, headers=headers, json=payload, timeout=120)
    data = r.json()
...
def call_openai_chat(api_key: str, model: str, prompt: str, fixed_params: dict):
    ...
    r = _post_with_retries(OPENAI_CHAT_URL, headers=headers, json=payload, timeout=120)
    data = r.json()
